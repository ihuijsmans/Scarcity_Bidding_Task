function [ onset_first_trigger] = wait_for_scanner_end(nScans, bitsiScanner, trigger, PTB)
...
if PTB
    ...
    %theImage_load=imread('loading.jpg');
    %imageTexture = Screen('MakeTexture', window, theImage_load);
    %Screen('DrawTexture', window, imageTexture,[],[0 0 1024 600], 0);
    Screen('DrawText',window, 'Waiting for data saving', 350, 300, 255);
    Screen('DrawText',window, int2str(nScans-nEvents), 500,480, 255);
    Screen(window,'Flip');
end
