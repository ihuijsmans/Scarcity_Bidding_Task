function [ onset_first_trigger] = wait_for_scanner_start( nScans, bitsiScanner, trigger, PTB)
...
if PTB
    ...
    Screen('DrawTexture', window, imageTexture,[],[0 30 1000 630], 0);
    %Screen('DrawText',window, 'Waiting for Scanner', 780, 250, 255);
    Screen('DrawText',window, int2str(nScans-nEvents), 500,700, 255);
    Screen(window,'Flip');
end
