...
instructions(window, instruct_dir, SG_instr, nextkey, backkey);
...
instructions(window, instruct_dir, ST_inst, nextkey, backkey);

%Practice Shoptask
MRI_ShopTask_Practice_12_16(window, vars, ppnr, mainstart, 1, fid_newtask, fid_slider)

%Instructions real experiment
instructions(window, instruct_dir, post_inst, nextkey, backkey);
