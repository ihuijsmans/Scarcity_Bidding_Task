...
instructions(window, instruct_dir, 1:10, nextkey, backkey);
...
instructions(window, instruct_dir, 11:20, nextkey, backkey);

%Practice Shoptask
BEH_ShopTask_Practice_12_10(window, vars, ppnr, mainstart, 1, fid_newtask, fid_slider)

%Instructions real experiment
instructions(window, instruct_dir, 21:22, nextkey, backkey);
